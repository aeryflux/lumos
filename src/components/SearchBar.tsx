...
const COUNTRY_EN: Record<string, string> = {
  ...
  'australië': 'Australia', 'australie': 'Australia', 'mexico': 'Mexico',
  ...
  'chili': 'Chile', 'peru': 'Peru', 'marokko': 'Morocco', 'nigeria': 'Nigeria',
  'kenia': 'Kenya', 'ethiopië': 'Ethiopia', 'ethiopie': 'Ethiopia',
  'tanzania': 'Tanzania', 'algerije': 'Algeria', 'senegal': 'Senegal',
  ...
  'sili': 'Chile', 'peru': 'Peru', 'fas': 'Morocco', 'nijerya': 'Nigeria',
  ...
  'norvec': 'Norway', 'norvec': 'Norway', 'danimarka': 'Denmark',
  ...
  'japan': 'Japan', 'brasilien': 'Brazil', 'tyskland': 'Germany',
  'spanien': 'Spain', 'storbritannien': 'United Kingdom', 'usa': 'United States',
  'ryssland': 'Russia', 'australien': 'Australia', 'mexiko': 'Mexico',
  'turkiet': 'Turkey', 'egypten': 'Egypt', 'sydafrika': 'South Africa',
  'indien': 'India', 'argentina': 'Argentina', 'chile': 'Chile',
  'marocko': 'Morocco', 'nigeria': 'Nigeria', 'etiopien': 'Ethiopia',
  'tanzania': 'Tanzania', 'algeriet': 'Algeria', 'senegal': 'Senegal',
  'belgien': 'Belgium', 'schweiz': 'Switzerland', 'osterrike': 'Austria', 'österrike': 'Austria',
  'grekland': 'Greece', 'polen': 'Poland', 'sverige': 'Sweden',
  'norge': 'Norway', 'danmark': 'Denmark', 'finland': 'Finland',
  'ungern': 'Hungary', 'rumänien': 'Romania', 'rumanien': 'Romania',
  'ukraina': 'Ukraine', 'indonesien': 'Indonesia', 'malaysia': 'Malaysia',
  'nya zeeland': 'New Zealand', 'sydkorea': 'South Korea',
  // Indonesian country names
  'jepang': 'Japan', 'brasil': 'Brazil', 'jerman': 'Germany',
  'spanyol': 'Spain', 'inggris': 'United Kingdom', 'amerika serikat': 'United States',
  'rusia': 'Russia', 'australia': 'Australia', 'meksiko': 'Mexico',
  'turki': 'Turkey', 'mesir': 'Egypt', 'afrika selatan': 'South Africa',
  'thailand': 'Thailand', 'india': 'India', 'argentina': 'Argentina',
  'cile': 'Chile', 'maroko': 'Morocco', 'nigeria': 'Nigeria',
  'etiopia': 'Ethiopia', 'tanzania': 'Tanzania', 'aljazair': 'Algeria',
  'belanda': 'Netherlands', 'belgia': 'Belgium', 'swiss': 'Switzerland',
  'austria': 'Austria', 'yunani': 'Greece', 'polandia': 'Poland',
  'swedia': 'Sweden', 'norwegia': 'Norway', 'denmark': 'Denmark',
  'finlandia': 'Finland', 'hungaria': 'Hungary', 'rumania': 'Romania',
  'ukraina': 'Ukraine', 'indonesia': 'Indonesia', 'malaysia': 'Malaysia',
