...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'search.showcase.music': 'Discover music',
    'search.found': 'Found:',
  ...
  fr: {
    ...
    'search.showcase.music': 'Découvrir la musique',
    'search.found': 'Trouvé :',
  ...
  es: {
    ...
    'search.showcase.music': 'Descubrir música',
  ...
  de: {
    ...
    'search.showcase.music': 'Musik entdecken',
