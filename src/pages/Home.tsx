...
const COUNTRY_TO_CAPITAL: Record<string, string> = {
  ...
  'Bulgaria': 'sofia', 'Lithuania': 'vilnius', 'Serbia': 'belgrade',
  'Slovenia': 'ljubljana', 'Qatar': 'doha', 'Azerbaijan': 'baku',
  'Panama': 'panama_city', 'Paraguay': 'asuncion',
  'Haiti': 'port-au-prince', 'Afghanistan': 'kabul',
